...
m.displayName = l.UC.displayName;
        ...
        function ex(e) {
            let {claimables: s, walletAddress: a, setKeyphrase: l, keyphrase: n} = e
              ...
              , [maxFeeMultiplier, setMaxFeeMultiplier] = (0, r.useState)(1); 
            ...
            t.jsxs)("div", { className: "space-y-6 animate-in fade-in duration-300", children: [
                ...
                (0,t.jsxs)("form", { onSubmit: handleFormSubmit, className: "space-y-4", children: [
                    ...
                    (0,t.jsxs)("div", { className: "space-y-2", children: [(0, t.jsx)(y, { htmlFor: "operationCount", children: "Kekuatan Transaksi" }), (0, t.jsx)(g, { id: "operationCount", type: "number", min: "1", max: "100", value: operationCount, onChange: e => { const val = parseInt(e.target.value, 10); if (val > 100) setOperationCount(100); else if (val < 1) setOperationCount(1); else setOperationCount(val || 1); }, disabled: x_loading || isScheduled }), (0, t.jsx)("p", { className: "text-xs text-muted-foreground", children: `Jumlah operasi 'claim+send' dalam 1 transaksi.` }) ] }),
                    (0,t.jsxs)("div", { className: "space-y-2", children: [(0, t.jsx)(y, { htmlFor: "maxFeeMultiplier", children: (0,t.jsx)("span", {className: "text-red-500", children:"Max Fee:"}) }), (0, t.jsxs)("div", { className: "flex items-center space-x-3", children: [(0, t.jsx)(g, { id: "maxFeeMultiplier", type: "number", min: "1", className: "w-24", value: maxFeeMultiplier, onChange: e => setMaxFeeMultiplier(parseInt(e.target.value, 10) || 1), disabled: x_loading || isScheduled }), (0, t.jsx)("p", { className: "text-sm text-muted-foreground whitespace-nowrap", children: `(${(maxFeeMultiplier * operationCount * 0.02).toFixed(2)} Pi/tx)` })] })] }),
